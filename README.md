...
본 프로젝트는 **'조선과 건축(KMUA)'** 거대 담론의 하위 실증 프로젝트입니다. 1920-30년대 『조선과 건축(朝鮮と建築)』 등에 수록된 **「신축공사개요」**를 텍스트 마이닝하여, 근대 건축의 생산과 구성을 입체적으로 분석할 수 있는 **지식 그래프(Knowledge Graph)**를 구축하는 것을 목표로 합니다.
